...
/**
 * Settings for UnofferedWorkItemObserver.
 * @author Philipp R. Thomas <philipp.thomas@floaz.de>
 */
public class UnofferedWorkItemsObserverSettings extends ItemBasesObserverSettings {
	public String filterMode;
	public List<TaskFilter> filterTasks;
